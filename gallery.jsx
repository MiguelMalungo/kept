    ...
    <>
      <section className="intro" id="gallery">
        <div>
          ...
          <h2>God, grant me the <span style={{ color: "var(--accent)" }}>Serenity</span> to accept the things I cannot change,<br/><span style={{ color: "var(--accent)" }}>Courage</span> to change the things I can,<br/><em>And <span style={{ color: "var(--ink)" }}>Wisdom</span> to know the difference.</em></h2>
        </div>
        <p>
